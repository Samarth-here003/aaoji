...
export default function MenuSection() {
  ...
  return (
    ...
    >
      {/* Headings */}
      <h4 className="text-blue-700 font-medium uppercase border-b-2 border-blue-700 inline-block mb-2">
        Explore Our Menu
      </h4>
      <h2
        id="menu-heading"
        className="text-2xl md:text-3xl text-blue-700 font-bold mb-10"
      >
